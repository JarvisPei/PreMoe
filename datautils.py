...
def get_ptb(nsamples, seed, seqlen, model, bsz = 8):
...
def get_c4_new(nsamples, seed, seqlen, model):
    ...
    traindata = datasets.load_from_disk("/mnt/sda3/hlzhen/datasets/allenai/c4/en/train")
    valdata = datasets.load_from_disk("/mnt/sda3/hlzhen/datasets/allenai/c4/en/validation")
...
def get_loaders(
    ...
    if 'c4' in name:
        ...
        return get_c4(nsamples, seed, seqlen, model, bsz = bsz)
